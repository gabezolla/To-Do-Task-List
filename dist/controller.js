...
(function (Controller) {
    ...
    */
    function handleEdit() {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            let checkedId = ((_a = getActiveView()) === null || _a === void 0 ? void 0 : _a.getCheckedIds()) || [];
            try {
                let oldItem = yield dao.getItem(checkedId[0]);
                let newItem;
                newItem = editView.parse(oldItem.id);
                yield dao.update(newItem);
                refreshActiveView();
    ...
    function initToolbar() {
        ...
        (_c = editButton.container) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
            var _d;
            let checkedId = ((_d = getActiveView()) === null || _d === void 0 ? void 0 : _d.getCheckedIds()) || [];
